          ...
          <div style={{ marginBottom: 40 }}>
            <div
              style={{
                ...
                margin: "0 auto 20px",
                transform:
                  "rotate(-10deg)" /* Làm cái logo hơi nghiêng nhìn cho chất */,
      ...
      <Tabs
        ...
        items={[
                  ...
                  items={[
                    {
                      ...
                      label: (
                        <Badge
                          count={orderCategorized.dangLam.length}
                          offset={[10, 0]}
                        >
                          <b>ĐANG SẢN XUẤT</b>
                        </Badge>
          ...
          },
          {
            ...
            label: (
              <b>
                <DatabaseOutlined /> KHO VẬT TƯ
              </b>
            ),
            children: (
              <MaterialManagement db={db} user={user} isAdmin={isAdmin} />
            ),
          },
        ]}
      />
